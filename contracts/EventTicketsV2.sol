...
contract EventTicketsV2 {
    ...
    */
    function buyTickets(uint eventId, uint noOfTickets) public payable {
        require(events[eventId].isOpen, "Event closed");
        require(msg.value >= noOfTickets * PRICE_TICKET, "Transaction value not enough");
        require(events[eventId].totalTickets >= noOfTickets, "incorrect number tickets left");
